            ...
            <div class="space-y-6">
                ...
                <div class="admin-card rounded-lg p-6">
                    ...
                    <div class="space-y-4">
                        ...
                        <div>
                            <label class="flex items-center">
                                <input type="checkbox" name="show_toc" value="1" {{ old('show_toc', true) ? 'checked' : '' }}
                                       class="rounded bg-gray-700 border-gray-600 text-blue-600 focus:ring-blue-500 focus:ring-offset-gray-800">
                        ...
                        <div>
                            ...
                            <div class="flex gap-4">
                                <label class="flex items-center">
                                    <input type="radio" name="toc_mode" value="auto" {{ old('toc_mode', 'auto') === 'auto' ? 'checked' : '' }}
                                           class="text-blue-600 focus:ring-blue-500">
                                    <span class="ml-2 text-gray-300 text-sm">Auto (from headings)</span>
                                </label>
                                <label class="flex items-center">
                                    <input type="radio" name="toc_mode" value="custom" {{ old('toc_mode') === 'custom' ? 'checked' : '' }}
                                           class="text-blue-600 focus:ring-blue-500">
                        ...
                        <!-- Custom TOC Content -->
                        <div id="toc-custom-section" style="display: none;">
                            ...
                            <input type="hidden" name="toc_content" id="toc_content" value='{{ old('toc_content') }}'>
